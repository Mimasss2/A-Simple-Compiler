...
public class SymbolTable {
    private Map<String, SymbolTableEntry> symbolEntryMap;

    public SymbolTable() {
        this.symbolEntryMap = new HashMap<String,SymbolTableEntry>();
    }
    ...
    public SymbolTableEntry get(String text) {
        if (symbolEntryMap == null || !symbolEntryMap.containsKey(text)) {
            throw new RuntimeException("Illegal Symbol");
        }
        return symbolEntryMap.get(text);
    }
    ...
    public SymbolTableEntry add(String text) {
        if (symbolEntryMap.containsKey(text)) {
            throw new RuntimeException("Symbol already in symbolTable!");
        }
        SymbolTableEntry newEntry = new SymbolTableEntry(text);
        symbolEntryMap.put(text, newEntry);
        return newEntry;
    }
    ...
    public boolean has(String text) {
        return symbolEntryMap.containsKey(text);
    }
